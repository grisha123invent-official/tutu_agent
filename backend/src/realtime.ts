        ...
        this.rtSend({
          ...
          response: {
            instructions: hadTalk
              ? 'Пользователь открыл голосовой режим и молчит. Мягко, одним коротким предложением спроси, чем ещё помочь (помня прошлый разговор). Без списков.'
              : 'Пользователь открыл голосовой режим и молчит секунд десять. Мягко, одним коротким предложением спроси, что он хотел / куда хочет поехать. Без списков.',
          },
        })
      }, 10000)
    })
